          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <motion.button
                ...
                className="h-12 px-8 bg-amber-400 text-slate-900 hover:bg-amber-500 font-bold shadow-lg shadow-amber-400/20 rounded-md inline-flex items-center justify-center text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
              >
                Search
              </motion.button>
            </div>
